    ...
    <ul class="w3-navbar" id="myNavbar">
      @if (Auth::check())
          @if (Auth::user()->isChef() && Session::get('login') == 'chef')
            ...
            <li class="w3-hide-small w3-right">
              <a href="{!! route('image.index', ['id' => encrypt(Auth::user()->chef_id)]) !!}" class="w3-padding-large w3-xlarge listcolor"><i class="fa fa-camera-retro"></i><span class="w3-large"> Image</span></a>
            </li>
            <li class="w3-hide-small w3-right">
            ...
            <li class="w3-hide-small w3-right">
              <a href="{!! route('order.cheforder', ['id' => encrypt(Auth::user()->chef_id)]) !!}" class="w3-padding-large w3-xlarge listcolor" id="chef_order" ><i class="fa fa-credit-card"></i><span class="w3-large"> Order</span></a>
            </li>
            <li class="w3-hide-small w3-right">
          ...
          @else 
            ...
            <li class="w3-hide-small w3-right">
              <a href="{!! route('order.userorder', ['id' => encrypt(Auth::user()->id)]) !!}" class="w3-padding-large w3-xlarge listcolor" id="chef_order" ><i class="fa fa-credit-card"></i><span class="w3-large"> Order</span></a>
            </li>
            <li class="w3-hide-small w3-right">
              <a href="{!! route('product.cart.show', ['id' => encrypt(Auth::user()->id)]) !!}" class="w3-padding-large w3-xlarge listcolor" id="shoppingCart" ><i class="fa fa-shopping-cart"></i><span class="w3-large"> Shopping Cart</span></a>
            </li>
            <li class="w3-hide-small w3-right">
