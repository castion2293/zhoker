...
@section('content')
    ...
    <div class="" id="top-pic">
        <img src="https://s3.amazonaws.com/zhoker-pics/2018051803.JPG" alt="profile" style="width:100%">
    </div>
               ...
               <div class="w3-col l4 m4">
                ...
                <div class="w3-col l8 m8" style="padding-left:2em;">
                  <div>
                      ...
                      <!--{{ Form::text('city' , null, ['class' => 'w3-input w3-border w3-border-grey w3-large w3-text-grey', 'placeholder' => $lang->desktop()['maplist_search']['city'], 'required' => '', 'maxlength' => '255']) }}-->
                  </div>
