  ...
  <div class="modal" id="DatetimePeopleModal" role="dialog">
    <div class="modal-dialog" style="width:100%;">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:10px 10px;margin-top:3em;">
            <div id='calendar'></div>
            <div class="w3-center w3-margin-top">
                <a href="#modal-picker" class="btn btn-success" id="confirm-btn" data-dismiss="modal" style="width:100%;">Confirm</a>
            </div>
        </div>
      </div>
