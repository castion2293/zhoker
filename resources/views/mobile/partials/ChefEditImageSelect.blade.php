        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="w3-center w3-margin-top">
                    <a href="#image-form" class="btn w3-large w3-green w3-text-white w3-border w3-border-green zk-shrink-hover" id="select-img" style="width:100%;" data-dismiss="modal">{{ $lang->desktop()['chef_edit']['select'] }}</a>
                </div>
            </div>
        </div>
