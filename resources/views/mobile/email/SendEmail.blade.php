...
@section('content')
    ...
    <div class="w3-content w3-container w3-padding-32">
        ...
        <div class="w3-content w3-container w3-center w3-border-green w3-border-bottom">
            <h3 class="w3-text-grey"  style="font-family: cursive">{{ $lang->desktop()['send_email']['congraduate'] }} <a href="{{ route('home.index') }}" style="text-decoration:none; "><span class="w3-text-green">Zhoker.com</span></a> {{ $lang->desktop()['send_email']['account'] }}!</h3>
