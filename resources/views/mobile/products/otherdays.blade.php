    ...
    <div class="w3-padding-32">
        <div class="w3-row w3-border-green w3-border-bottom">
            <div class="w3-col s12 w3-center">
                <h1 class="w3-text-grey w3-xxlarge w3-margin-left" style="font-family: cursive">{{ str_limit($meal->name, 24) }}</h1>
            </div>
                ...
                <div class="w3-margin-top w3-padding-12">
                    <table class="w3-table w3-bordered w3-medium">
                         <tr>
                            ...
                            <th class="w3-right" style="padding-right:2em;">{{ $lang->desktop()['other_day']['action'] }}</th>
                        </tr>
                        @foreach ($datetimepeoples as $datetimepeople)
                            <tr>
                                ...
                                <td class="w3-right"><a href="{{ route('product.show', ['id' => $meal->id, 'datetime_id' => $datetimepeople->id])}}" class="btn w3-deep-orange zk-shrink-hover w3-small">{{ $lang->desktop()['other_day']['add_to_cart'] }}</a></td>
                            </tr>
                        @endforeach
                    </table>
                </div>
