    ...
    <div class="w3-content w3-container w3-padding-32">
        ...
        <div class="w3-row">
            <div class="w3-col s12">
                ...
                <div class="w3-col s12 w3-center w3-margin-top">
                    <a href="{!! route('product.cart.show', ['id' => encrypt(Auth::user()->id)]) !!}" class="btn w3-white w3-text-green w3-border w3-border-green btn-block zk-shrink-hover" style="padding-left:0.5em;">Back to Shopping Cart</a>
                </div>
                        ...
                        @else 
                            ...
                            <div class="w3-row">
                                ...
                                <div class="w3-col l4 m4 w3-right w3-margin-top">
                                    {!! Form::submit('Confirm & Pay', ['class' => 'btn w3-deep-orange w3-largeEE btn-block zk-shrink-hover']) !!}
                                </div>
                            </div>  
                        @endif
                    </div>
